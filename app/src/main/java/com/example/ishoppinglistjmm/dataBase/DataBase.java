...
public class DataBase {
    ...
    public static void inicializeList() {
        if (productsList == null) {
            ...
            Product p1 = new Product(1, "Pizza", "High-quality pizza", true,false,false);
            productsList.add(p1);
            Product p2 = new Product(2, "Chicken Wings", "The authentic flavor", false, false, true);
            productsList.add(p2);
            Product p3 = new Product(3, "Spanish Omelette with Onion", "Traditional flavor", true, true, false);
            productsList.add(p3);
            Product p4 = new Product(4, "Burger", "Top-quality meat", true, false, true);
            productsList.add(p4);
            Product p5 = new Product(5, "Caesar Salad", "Fresh and healthy", false, true, false);
            productsList.add(p5);
            Product p6 = new Product(6, "Sushi", "Taste of Japan", true, false , true);
            productsList.add(p6);
            Product p7 = new Product(7, "Paella", "Typical Valencian", false, true, false);
            productsList.add(p7);
            Product p8 = new Product(8, "Taco", "Authentic Mexican", true, false, true);
            productsList.add(p8);
            Product p9 = new Product(9, "Lasagna", "Classic Italian recipe", true, true, false);
            productsList.add(p9);
            Product p10 = new Product(10, "Curry", "Spicy and tasty", false ,false, true);
            productsList.add(p10);
            Product p11 = new Product(11, "Club Sandwich", "Perfect for lunch", true, true ,false);
            productsList.add(p11);
            Product p12 = new Product(12, "Falafel", "Fried chickpea balls", true, false, true);
            productsList.add(p12);
            Product p13 = new Product(13, "Hot Dog", "The American classic", false, true, false);
            productsList.add(p13);
            Product p14 = new Product(14, "Quiche", "Tasty and versatile", true,false, true);
            productsList.add(p14);
            Product p15 = new Product(15, "Risotto", "Creamy and delicious", true, true ,true);
            productsList.add(p15);
            Product p16 = new Product(16, "Shawarma", "Spiced meat in pita bread", true, true, true);
            productsList.add(p16);
            Product p17 = new Product(17, "Meat Chili", "Spicy and hearty", true, true, false);
            productsList.add(p17);
            Product p18 = new Product(18, "Gyozas", "Japanese dumplings", true, false, true);
            productsList.add(p18);
            Product p19 = new Product(19, "Bagel", "Filled with cream cheese", false, true, false);
            productsList.add(p19);
            Product p20 = new Product(20, "Fideuà", "Seafood and noodles", true, false, true);
            productsList.add(p20);
            Product p21 = new Product(21, "Croquettes", "Creamy inside", true, true, false);
            productsList.add(p21);
            Product p22 = new Product(22, "Bruschetta", "Italian toasts", false, true, true);
            productsList.add(p22);
            Product p23 = new Product(23, "Ramen", "Japanese soup", true, true, false);
            productsList.add(p23);
            Product p24 = new Product(24, "Vegetable Pie", "Stuffed and baked", true, false, true);
            productsList.add(p24);
            Product p25 = new Product(25, "Moussaka", "Eggplant and meat", false, true, false);
            productsList.add(p25);
            Product p26 = new Product(26, "Fish and Chips", "Typical British", true , false, true);
            productsList.add(p26);
            Product p27 = new Product(27, "Chicken Curry", "Spiced and creamy", true, true, false);
            productsList.add(p27);
            Product p28 = new Product(28, "Burrito", "Mexican wrap", false, false, true);
            productsList.add(p28);
            Product p29 = new Product(29, "Noodles", "Asian noodles", true, true, false);
            productsList.add(p29);
            Product p30 = new Product(30, "Couscous", "With vegetables and meat", true, true, true);
